"""Smoke tests for AwdUI on macOS -- verify core tools work end-to-end."""
...
class TestDarwinSmoke:
    ...
    def test_platform_package_imports(self):
        """awdui_platform should import cleanly on macOS."""
        import awdui_platform
        assert hasattr(awdui_platform, "get_dpi_scale")
        assert hasattr(awdui_platform, "list_windows_native")
        assert hasattr(awdui_platform, "classify_window_native")
        assert hasattr(awdui_platform, "run_ocr_native")
