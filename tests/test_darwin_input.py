...
class TestDarwinGetForegroundType:
    """Verify get_foreground_type routes to awdui_platform on macOS."""

    def test_delegates_to_classify_window_native(self):
        """On macOS, get_foreground_type should use awdui_platform.classify_window_native."""
        from tools.window_classify import get_foreground_type

        with mock.patch("awdui_platform.classify_window_native") as mock_classify:
