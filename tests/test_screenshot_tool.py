...
class TestCaptureScreenshot:
    ...
    def test_path_comes_from_manager(self):
        result = self._patch_and_capture()
        assert result["path"] == "/tmp/awdui_fake/screenshot.png"
...
class TestActionToolResponse:
    def test_text_only_when_capture_false(self):
    ...
    def test_image_and_text_when_capture_true(self):
        ...
        fake_shot = _make_mss_monitor_shot(800, 600)
        fake_sct = mock.MagicMock()
        fake_sct.monitors = [
        ...
        with mock.patch.object(mod, "screenshot_manager") as mock_mgr:
            ...
            result = action_tool_response("Clicked.", capture=True)
        mod._sct = old_sct
