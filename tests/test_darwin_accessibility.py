...
class TestRoleMapping:
    ...
    def test_windows_to_ax_known(self):
        from awdui_platform.darwin_backend import windows_role_to_ax
    ...
    def test_ax_to_windows_known(self):
        from awdui_platform.darwin_backend import ax_role_to_windows
...
class TestAxElementToDict:
    ...
    def test_converts_element_with_all_attrs(self):
        from awdui_platform.darwin_backend import ax_element_to_dict
...
class TestDarwinUiAutomationRouting:
    ...
    def test_do_get_focused_element_calls_darwin_path(self):
        ...
        with mock.patch("awdui_platform.darwin_backend.ax_get_focused_element") as mock_ax:
